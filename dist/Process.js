...
class Process {
     ...
     */
    _moduleSettings = new ModuleSettings_1.ModuleSettings(this);
    /**
     *  @private
     *
     ...
     */
    constructor(moduleID, moduleName, htmlPath, ipcCallback) {
     ...
     */
    async handleExternal(source, eventType, ...data) {
     ...
     */
    async requestExternal(target, eventType, ...data) {
